...
Note that this repository contains legacy code for Nano Adblocker, the new
code can be found in the [Nano Core 2 repository](https://github.com/NanoAdblocker/NanoCore2).
